...
public class ActionsExamplesTest {
    ...
    void dragAndDropTest() throws InterruptedException {
        ...
        //Thread.sleep(2000);//TODO: заменить на хорошее ожидание
...
//                .get(0).getText().equals("ВЛАДЕЛЕЦ"));
        ...
        webDriverWait.until(elementWithTextFirstInCollection
                (By.xpath("//thead[@class='grid-header']//th[contains(@class,'sortable')]"), "ВЛАДЕЛЕЦ"));
    ...
    void iframeTest() throws InterruptedException {
        ...
        Thread.sleep(3000); //TODO: заменить на хорошее ожидание
